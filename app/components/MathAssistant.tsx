                    ...
                    <svg width="300" height="200" viewBox="-10 -100 220 120" className="overflow-visible">
                        ...
                        <path
                            d={func.includes('x²') || func.includes('^2')
                                ...
                                : "M 20 -20 L 180 -80"}
                            fill="none"
                            // Nouveau Graphe GeoGebra (L'élève voit la courbe directement)
            ...
            const match = content.match(/\[FIGURE: GGB: (.*?)\]/);
                ...
                try {
                    const data = JSON.parse(match[1]);
                        ...
                        // Fallback simplified (si besoin)
                        if (content.includes('[FIGURE: FunctionGraph:')) {
            return <p className="text-xs text-slate-500 italic px-4 my-2">Analyse graphique en cours...</p>;
        }
