                ...
                <div className="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-3xl p-5 md:p-8 shadow-2xl overflow-hidden relative group">
                    ...
                    <div className="space-y-6">
                        <button
                            ...
                            className={`w-full relative group overflow-hidden bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl py-3 px-4 flex items-center justify-center gap-3 transition-all active:scale-[0.98] ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
                            {isLoading ? (
                            ...
                            <span className="text-sm font-['Orbitron'] tracking-wider text-white">
                                {isLoading ? "Synchronisation..." : (mode === "login" ? "Continuer avec Google" : "S'inscrire avec Google")}
                            </span>
                        </button>
                        ...
                        <form className="space-y-6">
                            ...
                            {(authError || error) && (
                                <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-3 flex items-center gap-3">
                                    ...
                                    <p className="text-xs text-red-400 font-mono">{authError || error}</p>
                                </div>
                            )}
